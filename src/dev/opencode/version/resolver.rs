...
use crate::dev::opencode::version::cache;
use crate::dev::opencode::version::github::VersionFetcher;
...
mod tests {
    use super::*;
    use crate::dev::opencode::version::cache::{write_cache, CacheEntry};
    use std::fs;
    ...
    fn test_resolve_latest_fetches_when_cache_expired() {
        ...
        // Write a stale entry
        let stale_nanos = crate::dev::opencode::version::cache::now_nanos() - (48u64 * 3600 * 1_000_000_000);
